...
trmm_lat,trmm_lon,trmm_anomaly_0 = s2s_utility_prec.read_anomaly(cur_trmm_path,'TRMM')
ec_lat,ec_lon,ec_anomaly = s2s_utility_prec.read_anomaly(cur_ec_path,'ECMWF')
