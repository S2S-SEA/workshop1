...
Self-defined functions "read_trmm" and "plot_figure" are used to read TRMM dataset and for final visualization.
'''
...
for i_date in range(0,len(model_initial_date)):
    ...
    for i_year in range(start_year,end_year+1):
        ...
        for i_day in range(start_day,end_day+1):
            ...
            trmm_week_all = trmm_week_all + trmm_data[time_index,:,:];
            index = index + 1;
