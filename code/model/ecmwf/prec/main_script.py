...
Self-defined functions "read_ecmwf" and "plot_figure" are used to read ECMWF dataset and for final visualization.
'''
...
for i_date in range(0,len(model_initial_date)):
    ...
    for i_step in range(0,model_step):
        ...
        if index != 0:
           ...
           plot_figure.plot_figure(ec_week_climatology,ec_lat,ec_lon,target_start_date,target_end_date,model_date[:2],'none',str(i_step+1),'climatology');
